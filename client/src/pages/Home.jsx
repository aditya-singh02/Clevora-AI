  ...
  return (
    <div className="min-h-screen bg-[#030712] relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        {/* Top left glow */}
        <div className="absolute w-[700px] h-[700px] -top-64 -left-48 rounded-full
          bg-indigo-600/[0.06] blur-[130px]"/>
        {/* Bottom right glow */}
        <div className="absolute w-[600px] h-[600px] -bottom-48 -right-32 rounded-full
          bg-violet-600/[0.06] blur-[110px]"/>
        {/* Center subtle glow */}
        <div className="absolute w-[400px] h-[400px] top-1/2 left-1/2
      ...
      <nav className="relative z-10 flex items-center justify-between
        ...
        <div className="flex items-center gap-2.5">
          <motion.div
            animate={{ boxShadow: ['0 0 10px rgba(99,102,241,0.3)','0 0 20px rgba(139,92,246,0.45)','0 0 10px rgba(99,102,241,0.3)'] }}
            transition={{ duration: 2.5, repeat: Infinity }}
            className="w-8 h-8 rounded-[10px] bg-gradient-to-br from-indigo-500 to-violet-600
              flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
            C
          </motion.div>
          <span className="text-white font-bold text-lg tracking-tight">Clevora</span>
        </div>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center
        ...
        <motion.div
          ...
          <motion.h1
            ...
            Practice smarter.<br/>
            <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-violet-400
          ...
          <motion.p
            ...
            Upload your resume. AI conducts a real voice interview based on your profile.
